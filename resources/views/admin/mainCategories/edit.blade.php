...
{{--                                        components-tabs-of cat langs--}}
                                        <ul class="nav nav-tabs nav-underline no-hover-bg">
                                            @isset($mainCategory->categories)
                                                @foreach($mainCategory->categories as $index=>$translation)

                                            <li class="nav-item">
                                                <a class=" @if($index==0) ?active @endif  nav-link" id="home-tab3{{$index}}" data-toggle="tab" href="#home3" aria-controls="home3"
                                                ...
                                                <form class="form"
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="projectinput1">   اسم القسم - {{__('messages.'.$translation -> translation_lang)}}
                                                                    </label>
                                                                    <input type="text" id="name"
                                                                           class="form-control"
                                                                           placeholder="  "
